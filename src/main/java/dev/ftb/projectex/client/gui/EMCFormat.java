...
public class EMCFormat extends DecimalFormat {
    ...
    public StringBuffer format(double number, StringBuffer result, FieldPosition fieldPosition) {
        if (/*ProjectEXConfig.general.override_emc_formatter &&*/ number >= 1_000_000D && (ignoreShift || !Screen.hasShiftDown())) {
            double num;
            char c;
    ...
    public StringBuffer format(long number, StringBuffer result, FieldPosition fieldPosition) {
        if (/*ProjectEXConfig.general.override_emc_formatter &&*/ number >= 1_000_000L && (ignoreShift || !Screen.hasShiftDown())) {
            double num;
            char c;
